...
urlpatterns = [
    ...
    path('applicant/login-tracking/', views.applicant_login_tracking_view, name='auth-applicant-login-tracking'),
    path('applicant/forgot-tracking/', views.applicant_forgot_tracking_view, name='auth-applicant-forgot-tracking'),
